  ...
  return (
    <div className="space-y-4">
      ...
      <div className={card}>
              ...
              <tr className={`border-b ${darkMode ? "border-gray-700" : "border-gray-100"}`}>
                {[
                  ...
                  <th key={key}
                    ...
                    className={`px-4 py-3 text-xs font-semibold uppercase tracking-wide text-left cursor-pointer select-none transition-colors
                ...
                paged.map((tx) => {
                  ...
                  return (
                    <tr key={tx.id}
                      ...
                      <td className="px-4 py-3">
                        <span className={`inline-flex items-center px-2 py-0.5 rounded-lg text-xs font-medium capitalize
                          ${tx.type === "income"
                          ...
                          <div className="flex items-center justify-end gap-1">
                            <button onClick={() => handleEdit(tx)}
                              className={`w-7 h-7 rounded-lg flex items-center justify-center transition-colors
                                ${darkMode ? "hover:bg-gray-600 text-gray-400 hover:text-gray-200" : "hover:bg-gray-100 text-gray-500"}`}>
                              <Pencil size={12} />
                            </button>
        ...
        {/* Pagination */}
        {pages > 1 && (
          <div className={`flex items-center justify-between px-4 py-3 border-t ${darkMode ? "border-gray-700" : "border-gray-100"}`}>
